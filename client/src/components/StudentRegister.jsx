...
export default function StudentRegister({ onSuccess }) {
  // --- Set default role to 'student' for StudentRegister form ---
  const [formData, setFormData] = useState({ first_name: '', last_name: '', email: '', password_hash: '', role: 'student', major: '' });
  ...
  return (
    <form onSubmit={handleSubmit} className="register-form">
      ...
      <input name="major" type="text" placeholder="Major" required onChange={handleChange} />
