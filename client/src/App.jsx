...
//    - ✅ Delete Users ––> Remove student records w/ confirmation
...
const App = () => {
  const Navigation = () => {
    ...
    const profileTitle = `${user?.first_name}\'s Profile`;
            ...
            {loading ? (
              ...
              <>
                {user ? (
                  <>
                    <Link to='/profile'>
                      <img src="/src/assets/profile.gif" className='profileIcon' title={profileTitle} alt="profile button" />
                    </Link>
